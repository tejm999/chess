...
public class Board {
    ...
    static void startGame() {
        System.out.println("Welcome to chess! this is how to play:");
        ...
        System.out.println(
                "Pawns auto-promote to queens. The new queens will be what the pawn's file was. \"queenH\"");
        System.out.println(
